...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-[1000] pt-6 transition-all duration-[400ms] ease-in-out transform-gpu [transform:translateZ(0)] [backface-visibility:hidden] isolate ring-0 ![transition-property:background-color,backdrop-filter,-webkit-backdrop-filter,box-shadow] ${
        scrolled
